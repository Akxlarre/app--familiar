...
| `scan-receipt-inventory` | Escaneo de boleta con Gemini; devuelve items estructurados | POST con `{ storage_path, household_id }` | `GEMINI_API_KEY` | [index.ts](scan-receipt-inventory/index.ts) |
